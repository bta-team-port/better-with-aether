...
public class BlockModelRetroDoor<T extends BlockLogicDoor> extends BlockModelDoor<T> {
    private final Map<Side, IconCoordinate> retroTextures = new EnumMap<>(Side.class);

    public BlockModelRetroDoor(Block<T> block) {
        super(block);
    }
    ...
    public BlockModelRetroDoor<T> setRetroTex(String texture, Side @NonNull ... sides) {
