...
public class BlockModelRetroAxisAligned<T extends BlockLogic> extends BlockModelAxisAligned<T> {
    private final Map<Side, IconCoordinate> retroTextures = new EnumMap<>(Side.class);

    public BlockModelRetroAxisAligned(Block<T> block) {
        super(block);
    }
    ...
    public BlockModelRetroAxisAligned<T> setRetroTex(String texture, Side @NonNull ... sides) {
