...
/// we have more than enough to fill a class with constants
public class AetherGlobals {
    public static final byte HELMET_SLOT = 3;
    public static final byte BODY_SLOT = 2;
    public static final byte LEGGING_SLOT = 1;
    public static final byte BOOTS_SLOT = 0;
