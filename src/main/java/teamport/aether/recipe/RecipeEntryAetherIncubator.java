...
public class RecipeEntryAetherIncubator extends RecipeEntryBase<RecipeSymbol, Mob, Integer> implements HasJsonAdapter {

    public RecipeEntryAetherIncubator(RecipeSymbol input, Mob output, Integer time) {
        super(input, output, time);
    }

    public RecipeEntryAetherIncubator() {
    }
