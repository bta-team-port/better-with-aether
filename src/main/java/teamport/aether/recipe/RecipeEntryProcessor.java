package teamport.aether.data.registry.recipe.entry;

import net.minecraft.core.data.registry.Registries;
import net.minecraft.core.data.registry.recipe.*;
import net.minecraft.core.data.registry.recipe.adapter.RecipeJsonAdapter;
import net.minecraft.core.item.ItemStack;
import teamport.aether.data.registry.recipe.adapter.RecipeProcessorJsonAdapter;

import java.util.List;
import java.util.Objects;

public class RecipeEntryProcessor extends RecipeEntryBase<RecipeSymbol, ItemStack, Integer> implements HasJsonAdapter {

    public RecipeEntryProcessor(RecipeSymbol input, ItemStack output, Integer time) {
