...
public class TerrainGeneratorAetherAmplified extends TerrainGeneratorLerp {
    public final DensityGenerator densityGenerator;

    public TerrainGeneratorAetherAmplified(World world) {
        super(world);
        this.densityGenerator = new DensityGeneratorAetherAmplified(world);
    }
