...
public class JumpRoom extends BaseBronzeRoom{
    ...
    public void makeRoom() {
        ...
        // Platforms
        decoration.add(drawPlane(random, ROOM_PALLET, SOUTH, 2, EAST, 4, x + 4, y + 7, z + 1, true));
        decoration.add(drawPlane(random, ROOM_PALLET, SOUTH, 4, EAST, 2, x + 1, y + 7, z + 4, true));
        decoration.add(drawPlane(random, ROOM_PALLET, SOUTH, 4, EAST, 2, x + 9, y + 7, z + 4, true));
        decoration.add(drawPlane(random, ROOM_PALLET, SOUTH, 2, EAST, 4, x + 4, y + 7, z + 9, true));
