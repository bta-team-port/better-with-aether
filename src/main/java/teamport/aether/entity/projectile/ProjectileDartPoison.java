...
public class ProjectileDartPoison extends ProjectileDart {
    ...
    public void onHit(HitResult hitResult) {
        ...
        if (hitResult.entity.hurt(this.owner, this.damage, DamageType.COMBAT)) {
            ...
            AetherEffects.fixedAdd(effectPlayer, AetherEffects.poisonEffect, this.poisonEffectDuration);
            if (this.isOnFire()) {
    ...
    public void setPoisonEffectDuration(short poisonEffectDuration) {
        this.poisonEffectDuration = poisonEffectDuration;
    }
}
