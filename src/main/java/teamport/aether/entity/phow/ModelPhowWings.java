...
public class ModelPhowWings extends ModelBase {
    ...
    public static MobPhow cow;

    public ModelPhowWings() {
        ...
        this.rightWingOuter.yRot = 3.1415927F;
    }
    ...
    public void render(float limbSwing, float limbYaw, float limbPitch, float headYaw, float headPitch, float scale) {
        ...
        this.leftWingInner.zRot = cow.wingAngle + wingBend + 1.5707964F;
        this.leftWingOuter.zRot = cow.wingAngle - wingBend + 1.5707964F;
        this.rightWingInner.zRot = -(cow.wingAngle + wingBend - 1.5707964F);
        this.rightWingOuter.zRot = (cow.wingAngle - wingBend + 1.5707964F);
