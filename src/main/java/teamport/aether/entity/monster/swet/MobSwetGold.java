...
public class MobSwetGold extends MobSwet implements Enemy {
    ...
    public void doTickEffect() {
        if (random.nextInt(2) == 0) {
            this.ParticleHelper.spawnParticle(world, "arrowtrail", this.x, this.y, this.z, this.xd * 0.05, this.yd * 0.05 - 0.1, this.zd * 0.05, 0);
            this.ParticleHelper.spawnParticle(world, "arrowtrail", this.x + this.xd * 0.5, this.y + this.yd * 0.5, this.z + this.zd * 0.5, this.xd * 0.05, this.yd * 0.05 - 0.1, this.zd * 0.05, 0);
        }
    }
