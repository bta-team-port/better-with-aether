...
public class AetherAchievements {
    ...
    public static final Achievement BRONZE = new Achievement(key("bronze"), "aether.bronze", AetherItems.KEY_BRONZE, HOSTILE_PARADISE).setType(Achievement.TYPE_SPECIAL).registerAchievement();
    public static final Achievement SILVER = new Achievement(key("silver"), "aether.silver", AetherItems.KEY_SILVER, BRONZE).setType(Achievement.TYPE_SPECIAL).registerAchievement();
