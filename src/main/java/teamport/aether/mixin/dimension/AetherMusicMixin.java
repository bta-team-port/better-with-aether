...
public abstract class AetherMusicMixin {
    ...
    public boolean tickOne(World instance, int x, int y, int z, Operation<Boolean> original) {
    ...
    public SoundEvent tickTwo(SoundRepository instance, String s, Operation<SoundEvent> original) {
