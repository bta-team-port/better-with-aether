...
public abstract class BlockLogicPistonBaseSteelMixin {
    ...
    private EntityFallingBlock makeFloatingBlockOne(World world, double x, double y, double z, int blockId, int blockMeta, TileEntity tileEntity, Operation<EntityFallingBlock> original, @Local @NonNull Block<?> block, @Share("entityFloatingBlock") LocalRef<EntityFloatingBlock> entityFloatingBlock) {
    ...
    private void makeFloatingBlockTwo(Entity instance, IVehicle vehicle, Operation<Void> original, @Share("entityFloatingBlock") @NonNull LocalRef<EntityFloatingBlock> entityFloatingBlock) {
    ...
    private boolean makeFloatingBlockThree(World instance, Entity entity, Operation<Boolean> original, @Share("entityFloatingBlock") @NonNull LocalRef<EntityFloatingBlock> entityFloatingBlock) {
        EntityFloatingBlock floatingBlock = entityFloatingBlock.get();
    ...
    private void makeFloatingBlockFour(EntityFallingBlock instance, double xd, double yd, double zd, float pushTime, Operation<Void> original, @Share("entityFloatingBlock") @NonNull LocalRef<EntityFloatingBlock> entityFloatingBlock) {
        EntityFloatingBlock floatingBlock = entityFloatingBlock.get();
        if (floatingBlock != null) {
