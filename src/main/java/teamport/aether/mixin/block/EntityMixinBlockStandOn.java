...
public abstract class EntityMixinBlockStandOn {
	...
	public boolean insureAlwaysTriggerEvent(
		...
		if(!original && blockWalkedOn != null && blockWalkedOn.getLogic() instanceof AetherBlockTriggerStandOn){
	...
	public boolean onEntityStand(
		...
		if(!original && blockWalkedOn != null && blockWalkedOn.getLogic() instanceof AetherBlockTriggerStandOn){
			Entity asThis = (Entity) (Object) this;
            AetherBlockTriggerStandOn triggeredBlock = (AetherBlockTriggerStandOn) blockWalkedOn.getLogic();
