...
public class AetherHudComponents {
    ...
    public static void registerHudComponents() {
        EXTRA_HEALTH_BAR = HudComponents.register(new ComponentExtraHealthBar("aetherExtraHealth", new LayoutSnap(HEALTH_BAR, ComponentAnchor.TOP_LEFT, ComponentAnchor.BOTTOM_LEFT)));
    }
