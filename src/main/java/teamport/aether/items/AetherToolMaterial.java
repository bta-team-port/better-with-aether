...
public class AetherToolMaterial {
    ...
    public static final ToolMaterial zanite    = new ToolMaterial().setDurability(384).setEfficiency(6.0F, 8.0F).setMiningLevel(2);
    public static final ToolMaterial gravitite = new ToolMaterial().setDurability(1536).setEfficiency(10.0F, 25.0F).setMiningLevel(3).setDamage(4).setBlockHitDelay(4);
    ...
    public static final ToolMaterial special   = new ToolMaterial().setDurability(256).setEfficiency(2.0f, 4.0f).setMiningLevel(0).setDamage(1);
}
