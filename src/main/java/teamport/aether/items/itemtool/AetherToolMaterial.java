...
public class AetherToolMaterial {
    ...
    public static final ToolMaterial gravitite = new ToolMaterial().setDurability(1536).setEfficiency(10.0F, 25.0F).setMiningLevel(3);
    ...
    public static final ToolMaterial special = new ToolMaterial().setDurability(768).setEfficiency(5.0f, 7.0f).setMiningLevel(2).setDamage(0);
