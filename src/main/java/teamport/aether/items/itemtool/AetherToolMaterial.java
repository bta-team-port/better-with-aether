...
public class AetherToolMaterial {
    ...
    public static final ToolMaterial ZANITE = new ToolMaterial().setDurability(384).setEfficiency(8.0F, 12.0F).setMiningLevel(2);
    public static final ToolMaterial GRAVITITE = new ToolMaterial().setDurability(1536).setEfficiency(12.0F, 25.0F).setMiningLevel(3);
    ...
    public static final ToolMaterial SPECIAL = new ToolMaterial().setDurability(256).setEfficiency(5.0f, 7.0f).setMiningLevel(2).setDamage(2);
}
