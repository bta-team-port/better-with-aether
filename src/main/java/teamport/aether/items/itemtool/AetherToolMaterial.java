...
public class AetherToolMaterial {
    ...
    public static final ToolMaterial GRAVITITE = new ToolMaterial().setDurability(1536).setEfficiency(10.0F, 25.0F).setMiningLevel(3).setDamage(3);
    ...
    public static final ToolMaterial SPECIAL = new ToolMaterial().setDurability(256).setEfficiency(5.0f, 7.0f).setMiningLevel(0).setDamage(2);
}
