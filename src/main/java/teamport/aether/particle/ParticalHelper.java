...
public class ParticalHelper {
    ...
    // TODO the particles should not appear in front of the pov
    ...
    // TODO adjust how particles move and how many spawn
    public static void spawnRemedyParticle(@Nullable World world, double x, double y, double z, float bbHeight, float bbWidth) {
        float width = 1.0f;
        for (int i = 0; i < 5; ++i) {
            double dx = random.nextGaussian() * 0.02;
            double dy = random.nextGaussian() * 0.02;
