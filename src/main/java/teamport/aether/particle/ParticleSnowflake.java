...
public class ParticleSnowflake extends Particle {
    public ParticleSnowflake(World world, double x, double y, double z, double xa, double ya, double za) {
        ...
        this.setScale((random.nextFloat() * 0.2F + 0.8F));
        ...
        this.yd = -0.02F - (random.nextFloat() * 0.01F);
        this.gravity = 0.01F;
        this.lifetime = (int) (20.0 / (0.5 + 0.5 * (random.nextInt(10000) / 10000.0)));
        this.xd *= 0.8F;
        this.zd *= 0.8F;
    }
    ...
    public void tick() {
        ...
        this.xd += (random.nextFloat() - random.nextFloat()) * 0.002F;
        this.zd += (random.nextFloat() - random.nextFloat()) * 0.002F;
