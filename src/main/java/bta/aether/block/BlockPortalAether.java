...
public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
    ...
    if ((meta & 2) > 0 && rand.nextInt(20) == 0) {
        world.playSoundEffect((Entity)null, SoundCategory.WORLD_SOUNDS, (double)x + 0.5, (double)y + 0.5, (double)z + 0.5, "portal.portal", 0.5F, rand.nextFloat() * 0.4F + 0.8F);
    }
    ...
    for(int l = 0; l < 4; ++l) {
        ...
        world.spawnParticle("aether", d, d1, d2, d3, d4, d5, 0);
    }

}

    @Override
    public String portalTrigger() {
