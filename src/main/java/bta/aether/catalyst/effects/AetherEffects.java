...
public class AetherEffects {
    ...
    public static final PoisonEffect poisonEffect = new PoisonEffect("effect.aether.poison", MOD_ID+":poison", "", 0xFF9a009a, CatalystEffects.listOf(new Modifier[]{}), EffectTimeType.RESET, 100, 10);
    public static final RemedyEffect remedyEffect = new RemedyEffect("effect.aether.remedy", MOD_ID+":remedy", "", 0xFF99FF99, CatalystEffects.listOf(new Modifier[]{}), EffectTimeType.RESET, 10, 1);
