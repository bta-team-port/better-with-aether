...
public class EntityArrowFlaming extends Entity {
    protected int xTile;
    protected int yTile;
    protected int zTile;
    ...
    public void tick() {
        ...
        if (this.inGround) {
            ...
            if (this instanceof EntityArrowFlaming) {
                ...
                //this.world.spawnParticle("smoke", this.x, this.y, this.z, this.xd * 0.05000000074505806, this.yd * 0.05000000074505806 - 0.10000000149011612, this.zd * 0.05000000074505806);
                this.world.spawnParticle("smoke", this.x + this.xd * 0.5, this.y + this.yd * 0.5, this.z + this.zd * 0.5, this.xd * 0.05000000074505806, this.yd * 0.05000000074505806 - 0.10000000149011612, this.zd * 0.05000000074505806);
            }
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entity != null) {
                    ...
                    } else if (!(this instanceof EntityArrowFlaming)) {
    ...
    public void renderArrow(EntityArrowFlaming arrow, double x, double y, double z, float yaw, float renderPartialTicks) {
    ...
    public void doRender(EntityArrowFlaming entity, double x, double y, double z, float yaw, float renderPartialTicks) {
        this.renderArrow(entity, x, y, z, yaw, renderPartialTicks);
    }
